...
type ServerConfig struct {
	...
	// DenyLiterals mirrors the chest:<name> reference from
	// `config.Server.DenyLiterals`. Empty when nothing's configured.
	// See plan 20.
	DenyLiterals string `json:"deny_literals,omitempty"`
}
