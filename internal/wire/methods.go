...
const (
	...
	MethodPatNew          = "pat.new"
	MethodPatUpdate       = "pat.update"
	MethodPatList         = "pat.list"
	MethodPatShow         = "pat.show"
	MethodPatRemove       = "pat.remove"
	MethodPatFindForClone = "pat.find_for_clone"
...
func Methods() []string {
	return []string{
		...
		MethodPatNew, MethodPatUpdate, MethodPatList, MethodPatShow, MethodPatRemove, MethodPatFindForClone,
